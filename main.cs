...
namespace Projekt {
    class Program {
        ...
        static long CalculateFactorialRecursive(long n) {
            if (n < 0) {
                throw new ArgumentException("Input must be a non-negative integer.");
            }
            if (n == 0 || n == 1) {
        ...
        public static void Main(string[] args) {
            ...
            long faktorijel2 = Program.CalculateFactorialRecursive(n);
            ...
            Console.WriteLine("'Klasicni' faktorijel broja " + n + " rekurzivnom funkcijom je " + faktorijel);
